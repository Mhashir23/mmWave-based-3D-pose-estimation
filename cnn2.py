...
total_res.to_csv('cnn3res.csv', index=False)
...
# Save results to CSV
eval_results.to_csv('joint_wise_evaluation_with_totals3.csv', index=False)
...
plt.tight_layout()
plt.savefig('joint_wise_evaluation_with_totals3.png')
plt.show()


# Save the model and results
cnn_model.save('mars_cnn_model3.h5')
np.save('test_predictions3.npy', predictions)
np.save('test_ground_truth3.npy', y_test)
